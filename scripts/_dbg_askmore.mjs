...
await page.locator("button:has-text('SUBMIT')").first().click(); await page.waitForTimeout(6000)
await page.screenshot({ path: "/tmp/dbg-askmore.png" })
const h4s = await page.locator("h4").allTextContents()
console.log("h4:", JSON.stringify(h4s))
console.log("武康路 text count:", await page.locator("text=武康路").count())
await b.close()
